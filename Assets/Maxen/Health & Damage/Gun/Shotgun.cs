...
public class Shotgun : Gun
{
    ...
    {
        Instantiate(_bullet, _bulletSpawn.position, _bulletSpawn.rotation * Quaternion.Euler(0, 0, _bulletSpread / 2.0f)).Initialize(_damage, _knockbackScalar, _bulletSpeed);
        Instantiate(_bullet, _bulletSpawn.position, _bulletSpawn.rotation * Quaternion.Euler(0, 0, -_bulletSpread / 2.0f)).Initialize(_damage, _knockbackScalar, _bulletSpeed);
